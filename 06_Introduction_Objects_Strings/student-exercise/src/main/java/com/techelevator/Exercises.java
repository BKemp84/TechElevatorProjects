...
public class Exercises {
	...
	public String right2(String str) {
		int currentPosition = str.length() -2;
		
		return (str.substring(currentPosition) + str.substring(0,currentPosition));
	}
	...
	public String withoutEnd2(String str) {
		...
		if (current >= 3) {
			return str.substring(1,current-1 );
		}
		return "";
	}
	...
	public String middleTwo(String str) {
		int currentMiddle = str.length() /2 -1;
		
		
		return str.substring(currentMiddle, currentMiddle + 2);
	}
